                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo 'PHP. ' . number_format($t->transaksi_harga) ?></td>
                            <td><?php echo 'PHP. ' . number_format($t->transaksi_denda) ?></td>
                            <td><?php echo ($t->transaksi_tgldikembalikan == '0000-00-00') ? '--' : date('d/m/Y', strtotime($t->transaksi_tgldikembalikan)); ?></td>
                            <td><?php echo 'PHP. ' . number_format($t->transaksi_totaldenda) ?></td>
                            <td>
                                <?php
